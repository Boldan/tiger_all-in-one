...
import "yaml"
local 词库文件=tostring(service.getLuaDir("")).."/richangtianjia.txt"--用户码表
local 词库文件2=tostring(service.getLuaDir("")).."/richangtianjia.txt"--用户码表
local 单字码表路径=tostring(service.getLuaDir("")).."/luna_pinyin.dict.yaml"--单字码表
local 参数=(...)
